"""
FSDP training with WandB + MLFlow + TensorBoard (All-in-One)
"""
import os
import logging
import argparse
...
def fsdp_main(rank, world_size, args):
    ...
    model = FSDP(model, sharding_strategy=ShardingStrategy.FULL_SHARD, device_id=rank, use_orig_params=True)
