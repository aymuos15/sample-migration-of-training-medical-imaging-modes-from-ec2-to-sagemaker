"""
FSDP training with Weights & Biases (WandB) integration
"""
import os
import logging
import argparse
...
def parse_args():
    ...
    parser.add_argument("--wandb_project", type=str, default="medical-segmentation-fsdp")
...
def fsdp_main(rank, world_size, args):
    ...
    if rank == 0:
        ...
        logger.info(f"Training {args.model_name} with FSDP + WandB")
